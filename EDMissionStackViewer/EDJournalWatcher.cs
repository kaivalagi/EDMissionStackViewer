...
namespace EDMissionStackViewer
{
    public class EDJournalWatcher
    {
        ...
        public Dictionary<string, Dictionary<Guid, dynamic>> CmdrJournalEventQueue = new Dictionary<string, Dictionary<Guid, dynamic>>();
        public Dictionary<string, List<EDJournalActiveMission>> CmdrMissions = new Dictionary<string, List<EDJournalActiveMission>>();
                        ...
                        if (journalEntry != null)
                        {
                            ...
                            switch (journalEntryEvent)
                            {
                                ...
                                case "Missions":
                                    ...
                                    CmdrMissions[commanderName] = new List<EDJournalActiveMission>();
                                    ...
                                    {
                                        CmdrJournalEventQueue[commanderName] = new Dictionary<Guid, dynamic>(); // new mission list found, only interested in newer entries
                                    }
                                    ...
                                    if (activeMissions.Count() > 0)
                                    {
                                        ...
                                        {
                                            var edJournalMission = new EDJournalActiveMission(activeMission);
                                ...
                                case "MissionAccepted":
                                    ...
                                    CmdrJournalEventQueue[commanderName].Add(Guid.NewGuid(), mission);
                                    break;
                                ...
                                case "MissionRedirected":
                                    ...
                                    CmdrJournalEventQueue[commanderName].Add(Guid.NewGuid(), missionOther);
                                    break;
                                ...
                                case "CargoDepot":
                                    ...
                                    var cargoDepot = journalEntry.Populate();
                                    if (cargoDepot.UpdateType == "Deliver")
                                    {
                                        //CmdrJournalEventQueue[commanderName].Enqueue(journalEntry);
                                        CmdrJournalEventQueue[commanderName].Add(Guid.NewGuid(), cargoDepot);
                                    }
                                    break;
                                ...
                                case "Bounty":
                                    ...
                                    //CmdrJournalEventQueue[commanderName].Enqueue(journalEntry);
                                    var bounty = journalEntry.Populate();
                                    CmdrJournalEventQueue[commanderName].Add(Guid.NewGuid(), bounty);
                                    break;
